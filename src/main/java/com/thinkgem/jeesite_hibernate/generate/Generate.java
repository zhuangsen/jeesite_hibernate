 ...
 */
package com.thinkgem.jeesite_hibernate.generate;
...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.thinkgem.jeesite_hibernate.modules";
		...
		// 模板文件路径
		String tplPath = StringUtils.replace(projectPath+"/src/main/java/com/thinkgem/jeesite_hibernate/generate/template", "/", separator);
