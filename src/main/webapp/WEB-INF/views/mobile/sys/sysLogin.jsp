	...
	<div data-role="page">
		...
		<div role="main" class="ui-content">
			<div id="messageBox" class="<%=error==null?"hide":""%>">
				<label id="loginError" class="error"><%=error==null?"":"com.thinkgem.jeesite_hibernate.modules.sys.security.CaptchaException".equals(error)?"验证码错误, 请重试.":"用户或密码错误, 请重试." %></label>
			</div>
